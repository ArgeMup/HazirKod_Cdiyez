...
{
    public class YanUygulama_Şebeke_ : IDisposable
    {
        string DosyaYolu;
        ...
        public YanUygulama_Şebeke_(string DosyaYolu, GeriBildirim_İşlemi_Uygulama_ GeriBildirim_İşlemi_Uygulama, Çalıştır_ ÇalıştırılanUygulamalarDeposu, IDepo_Eleman Ayarlar, string AğAdresi_Uygulama = null, string EnDüşükSürüm = "0.0", string AğAdresi_DoğrulamaKodu = null)
        {
        ...
        void GeriBildirim_Islemi_TcpSunucu(string Kaynak, GeriBildirim_Türü_ Tür, object İçerik, object Hatırlatıcı)
        {
            ...
            GeriBildirim_İşlemi_Uygulama(TcpSunucu_BağlantıKuruldu != null, Tür == GeriBildirim_Türü_.BilgiGeldi ? İçerik as byte[] : null, null);
        }
    ...
    public class YanUygulama_Şube_ : IDisposable
    {
        public delegate void GeriBildirim_İşlemi_Uygulama_(bool BağlantıKuruldu, byte[] Bilgi, string Açıklama);
        GeriBildirim_İşlemi_Uygulama_ GeriBildirim_İşlemi_Uygulama;
        ...
        public YanUygulama_Şube_(int ErişimNoktası, GeriBildirim_İşlemi_Uygulama_ GeriBildirim_İşlemi_Uygulama)
        {
        ...
        void GeriBildirim_Islemi_Tcpİstemci(string Kaynak, GeriBildirim_Türü_ Tür, object İçerik, object Hatırlatıcı)
        {
            ...
            GeriBildirim_İşlemi_Uygulama?.Invoke(Tcpİstemci_BağlantıKuruldu, Tür == GeriBildirim_Türü_.BilgiGeldi ? İçerik as byte[] : null, null);
        }
